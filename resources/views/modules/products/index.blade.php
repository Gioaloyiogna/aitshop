...
@section('page-content')
                ...
                <ul class="list-group list-group-horizontal-sm" id="info-panel">
                    <li class="list-group-item">
                        <div class="m-0 p-0 font-weight-bold text-primary">
                            Total Products:
                            <span class="text-secondary" id="info-panel-total-students">{{ $productCount }}</span>
                        </div>
                    </li>
    ...
    @include('modules.products.modals.add-products')
    {{-- fetching products --}}
    <script>
